...
type
  ...
  { Type for LDAPClient search data:
    * array of entries
    * attributes is a TList of LDAPAttribute }
  LDAPEntryArray = array of LDAPEntry; 
  ...
  LDAPClient = class
    ...
    public
      ...
      function Search(catalogDN, filter : string;
                             ...
                             var searchResult : LDAPEntryArray) : LDAPClientStatus;
      ...
      function CompareAttributeValue(entryDN,
                                     attrName,
                                     attrValueToCompare : string) : boolean;
...
implementation
  ...
  begin
    ...
    //------------ Check syntax of search filter ---------------
    returnCode := ldap_check_filter(pLDAPSession, PChar(filter));
    if returnCode <> LDAP_SUCCESS then
    begin
      resTemp.numb := returnCode;
      resTemp.msg := 'Wrong search filter!';
      result := resTemp;
      Exit;
    end;
    ...
    try
      ...
      begin
        searchResult[iCnt].attributes := TList.Create;
        ...
        searchResult[iCnt].dn := ldap_get_dn(pLDAPSession, pEntry);
        ...
        begin
          ...
          searchResult[iCnt].attributes.Add(tempAttr);
        end;
