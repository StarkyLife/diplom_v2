...
begin
  { Attribute ADD }
  //newEntry := ADEntry.Create('MyTestAttribute3');
  //newEntry.AddAttribute('cn', ['MyTestAttribute3']);
  //newEntry.AddAttribute('objectClass', ['attributeSchema']);
  //newEntry.AddAttribute('attributeID', ['1.2.840.113556.1.8000.2554.13844.27783.13802.18569.40486.16667616.15992130']);
  //newEntry.AddAttribute('attributeSyntax', ['2.5.5.12']);
  //newEntry.AddAttribute('oMSyntax', ['64']);

  //newEntry.AddAttribute('isSingleValued', ['TRUE']);

  { Class ADD }
  newEntry := ADEntry.Create('MyTestClass3');
  newEntry.AddAttribute('cn', ['MyTestClass3']);
  newEntry.AddAttribute('objectClass', ['classSchema']);
  newEntry.AddAttribute('governsID', ['1.2.840.113556.1.8000.2554.13844.27782.13802.18569.40486.16667616.15992135']);
...
var
  ...
  status: ADSchemaStatus;
begin
  modifiedEntry := ADEntry.Create('MyTestClass3');
  //modifiedEntry.AddAttribute('objectClassCategory', ['1']); { not allowed to change }
  modifiedEntry.AddAttribute('mayContain', ['MyTest3']);
